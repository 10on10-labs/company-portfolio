              ...
              (
                ...
                return (
                  <div key={index} className="text-center">
                    ...
                    <h3 className="text-3xl md:text-4xl font-bold text-secondary-foreground mb-2">
                      {stat.number || ''}
                    </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                {(aboutData.story?.paragraphs || []).map((paragraph: string, index: number) => (
                  <p
                    key={index}
                    className={`text-muted-foreground leading-relaxed ${index < (aboutData.story?.paragraphs?.length || 1) - 1 ? 'mb-6' : ''}`}
                  >
                    {paragraph}
                  </p>
                ))}
