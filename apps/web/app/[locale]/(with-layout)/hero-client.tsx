    ...
    <section className="relative w-full text-black overflow-hidden py-8 md:py-12">
      <div className="relative z-10 flex flex-col justify-center items-center text-center max-w-6xl mx-auto px-4">
        ...
        <motion.p
          ...
          className="mt-6 max-w-3xl text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed"
        >
          {heroDescription}
        </motion.p>
        ...
        >
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-primary via-foreground to-primary bg-clip-text text-transparent pb-2">
              {expertiseTitle}
            </h2>
            <p className="text-muted-foreground mt-2">{expertiseSubtitle}</p>
          </motion.div>
