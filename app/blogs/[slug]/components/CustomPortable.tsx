...
//@TODO fix types issues replace any
export default function CustomPortableText({ className, value }: any) {
  const components: PortableTextComponents = {
    block: {
      h1: ({ children }) => <h1 className="my-4 text-4xl font-bold">{children}</h1>,
      h2: ({ children }) => <h2 className="my-3 text-3xl font-semibold underline">{children}</h2>,
      h3: ({ children }) => <h3 className="my-3 text-2xl font-medium">{children}</h3>,
      h4: ({ children }) => <h4 className="my-2 text-xl font-medium">{children}</h4>,
      h5: ({ children }) => <h5 className="my-2 text-lg font-medium">{children}</h5>,
      h6: ({ children }) => <h6 className="my-2 text-base font-medium">{children}</h6>,
