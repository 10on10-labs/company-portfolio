...
import { FormField, NumberInputProps, NumberSchemaType, set, unset } from 'sanity';
...
export function StarRatingInput(props: NumberInputProps<NumberSchemaType>) {
  ...
  return (
    <FormField title={props.schemaType.title} description={props.schemaType.description}>
      <Flex gap={2}>
